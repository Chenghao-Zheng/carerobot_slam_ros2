...
bool robot_communication__msg__chassis_control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_communication.msg._chassis_control.ChassisControl", full_classname_dest, 55) == 0);
  }
  robot_communication__msg__ChassisControl * ros_message = _ros_message;
  {  // xspeed
  ...
  {  // globalorlocal
    PyObject * field = PyObject_GetAttrString(_pymsg, "globalorlocal");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->globalorlocal = (Py_True == field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of ChassisControl */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_communication.msg._chassis_control");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ChassisControl");
  ...
  {  // globalorlocal
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->globalorlocal ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "globalorlocal", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
