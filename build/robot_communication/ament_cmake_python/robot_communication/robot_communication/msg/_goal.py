...
class Goal(metaclass=Metaclass_Goal):
    ...
    def __init__(self, **kwargs):
        ...
        self.position_yaw = kwargs.get('position_yaw', float())
    ...
    def __eq__(self, other):
        ...
        if self.position_y != other.position_y:
            return False
        if self.position_yaw != other.position_yaw:
            return False
        return True
    ...
    @builtins.property
    def position_yaw(self):
        """Message field 'position_yaw'."""
        return self._position_yaw

    @position_yaw.setter
    def position_yaw(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'position_yaw' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'position_yaw' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._position_yaw = value
