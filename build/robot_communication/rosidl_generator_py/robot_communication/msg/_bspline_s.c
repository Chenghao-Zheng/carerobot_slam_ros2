...
bool robot_communication__msg__bspline__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_communication.msg._bspline.Bspline", full_classname_dest, 40) == 0);
  }
  robot_communication__msg__Bspline * ros_message = _ros_message;
  {  // order
  ...
  {  // pts
    ...
    geometry_msgs__msg__Point * dest = ros_message->pts.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
PyObject * robot_communication__msg__bspline__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_communication.msg._bspline");
