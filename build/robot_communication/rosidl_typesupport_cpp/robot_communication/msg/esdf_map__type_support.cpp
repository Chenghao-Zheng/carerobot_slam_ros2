...
static const _EsdfMap_type_support_symbol_names_t _EsdfMap_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_communication, msg, EsdfMap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_communication, msg, EsdfMap)),
  }
};
...
{
  return &::robot_communication::msg::rosidl_typesupport_cpp::EsdfMap_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robot_communication, msg, EsdfMap)() {
  return get_message_type_support_handle<robot_communication::msg::EsdfMap>();
}
