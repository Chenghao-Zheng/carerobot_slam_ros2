...
#include "robot_communication/msg/detail/bspline__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // knots
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // knots
...
using _Bspline__ros_msg_type = robot_communication__msg__Bspline;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: pts
  {
    ...
    if (ros_message->pts.data) {
      geometry_msgs__msg__Point__Sequence__fini(&ros_message->pts);
    }
    if (!geometry_msgs__msg__Point__Sequence__init(&ros_message->pts, size)) {
...
size_t get_serialized_size_robot_communication__msg__Bspline(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Bspline__ros_msg_type * ros_message = static_cast<const _Bspline__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Bspline__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_communication__msg__Bspline(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_communication
size_t max_serialized_size_robot_communication__msg__Bspline(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_communication__msg__Bspline;
    is_plain =
      (
...
static size_t _Bspline__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_communication__msg__Bspline(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_communication, msg, Bspline)() {
