...
#include "robot_communication/msg/detail/esdf_map__rosidl_typesupport_fastrtps_c.h"
...
using _EsdfMap__ros_msg_type = robot_communication__msg__EsdfMap;
...
size_t get_serialized_size_robot_communication__msg__EsdfMap(
  const void * untyped_ros_message,
...
static uint32_t _EsdfMap__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_communication__msg__EsdfMap(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_communication
size_t max_serialized_size_robot_communication__msg__EsdfMap(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_communication__msg__EsdfMap;
    is_plain =
      (
...
static size_t _EsdfMap__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_communication__msg__EsdfMap(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_communication, msg, EsdfMap)() {
