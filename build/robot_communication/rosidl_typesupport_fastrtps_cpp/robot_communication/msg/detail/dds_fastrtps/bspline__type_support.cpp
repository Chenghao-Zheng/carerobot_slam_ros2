...
#include "robot_communication/msg/detail/bspline__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_communication::msg::Bspline;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_communication::msg::Bspline *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_communication::msg::Bspline *>(
    untyped_ros_message);
...
{
  return &robot_communication::msg::typesupport_fastrtps_cpp::_Bspline__handle;
}
