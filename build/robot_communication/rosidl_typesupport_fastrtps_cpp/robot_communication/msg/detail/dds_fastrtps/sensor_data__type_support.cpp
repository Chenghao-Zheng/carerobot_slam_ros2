...
#include "robot_communication/msg/detail/sensor_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_communication::msg::SensorData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_communication::msg::SensorData & ros_message)
{
  // Member: local_x_veloc
  cdr >> ros_message.local_x_veloc;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_communication::msg::SensorData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_communication::msg::SensorData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_communication::msg::SensorData *>(
    untyped_ros_message);
...
{
  return &robot_communication::msg::typesupport_fastrtps_cpp::_SensorData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_communication, msg, SensorData)() {
  return &robot_communication::msg::typesupport_fastrtps_cpp::_SensorData__handle;
}
