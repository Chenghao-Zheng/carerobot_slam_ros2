...
{
  new (message_memory) robot_communication::msg::Goal(_init);
}

void Goal_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robot_communication::msg::Goal *>(message_memory);
  typed_message->~Goal();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Goal_message_member_array[3] = {
  {
    ...
    offsetof(robot_communication::msg::Goal, position_x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_communication::msg::Goal, position_y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_communication::msg::Goal, position_yaw),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Goal_message_members = {
  ...
  "Goal",  // message name
  3,  // number of fields
  sizeof(robot_communication::msg::Goal),
...
{
  return &::robot_communication::msg::rosidl_typesupport_introspection_cpp::Goal_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_communication, msg, Goal)() {
  return &::robot_communication::msg::rosidl_typesupport_introspection_cpp::Goal_message_type_support_handle;
}
