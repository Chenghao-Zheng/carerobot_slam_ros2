...
#ifndef ROBOT_COMMUNICATION__MSG__DETAIL__BSPLINE__FUNCTIONS_H_
#define ROBOT_COMMUNICATION__MSG__DETAIL__BSPLINE__FUNCTIONS_H_
 ...
 * calls
 * robot_communication__msg__Bspline__init().
...
/**
 * It calls
 * robot_communication__msg__Bspline__fini()
 ...
 * robot_communication__msg__Bspline__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * robot_communication__msg__Bspline__Sequence__fini()
 * on the array,
...
#endif  // ROBOT_COMMUNICATION__MSG__DETAIL__BSPLINE__FUNCTIONS_H_
