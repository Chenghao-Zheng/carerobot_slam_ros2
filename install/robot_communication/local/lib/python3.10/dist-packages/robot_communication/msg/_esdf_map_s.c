...
bool robot_communication__msg__esdf_map__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_communication.msg._esdf_map.EsdfMap", full_classname_dest, 41) == 0);
  }
  robot_communication__msg__EsdfMap * ros_message = _ros_message;
  {  // origin_x
    ...
    ros_message->origin_x = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // origin_y
    ...
    assert(PyFloat_Check(field));
    ros_message->origin_y = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // resolution
...
PyObject * robot_communication__msg__esdf_map__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_communication.msg._esdf_map");
