...
class Metaclass_LocalizationInfoBroadcast(type):
    """Metaclass of message 'LocalizationInfoBroadcast'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'robot_communication.msg.LocalizationInfoBroadcast')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__localization_info_broadcast
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__localization_info_broadcast
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__localization_info_broadcast
            cls._TYPE_SUPPORT = module.type_support_msg__msg__localization_info_broadcast
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__localization_info_broadcast
...
class LocalizationInfoBroadcast(metaclass=Metaclass_LocalizationInfoBroadcast):
    """Message class 'LocalizationInfoBroadcast'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.xposition = kwargs.get('xposition', float())
        self.yposition = kwargs.get('yposition', float())
        self.xspeed = kwargs.get('xspeed', float())
        self.yspeed = kwargs.get('yspeed', float())
        self.xaccel = kwargs.get('xaccel', float())
        self.yaccel = kwargs.get('yaccel', float())
    ...
    def __eq__(self, other):
        ...
        if self.yspeed != other.yspeed:
            return False
        if self.xaccel != other.xaccel:
            return False
        if self.yaccel != other.yaccel:
            return False
    ...
    def xposition(self, value):
        if __debug__:
            assert \
                ...
                "The 'xposition' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'xposition' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._xposition = value

    @builtins.property
    def yposition(self):
        """Message field 'yposition'."""
    ...
    def yposition(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'yposition' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'yposition' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    @builtins.property
    def xaccel(self):
        """Message field 'xaccel'."""
        return self._xaccel

    @xaccel.setter
    def xaccel(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'xaccel' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'xaccel' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._xaccel = value

    @builtins.property
    def yaccel(self):
        """Message field 'yaccel'."""
        return self._yaccel

    @yaccel.setter
    def yaccel(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'yaccel' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'yaccel' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._yaccel = value
