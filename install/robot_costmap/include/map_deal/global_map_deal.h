 ...
 * @LastEditTime: 2026-08-31 18:00:00
...
namespace map_deal
{
class global_map_deal : public rclcpp::Node
{
private:
  ...
  rclcpp::Publisher<nav_msgs::msg::OccupancyGrid>::SharedPtr global_inflate_map_publiser;      //  全局地图发布
  rclcpp::Publisher<nav_msgs::msg::OccupancyGrid>::SharedPtr global_esdf_map_publisher; //全局距离场地图发布

  rclcpp::Subscription<nav_msgs::msg::OccupancyGrid>::SharedPtr map_subscriber;  // 全局地图地图订阅
  void MapCallback(const nav_msgs::msg::OccupancyGrid::SharedPtr map);
  rclcpp::Subscription<nav_msgs::msg::Odometry>::SharedPtr localizationSub;        // 订阅当前车的姿态消息
  void localizationCallback(const nav_msgs::msg::Odometry::SharedPtr msg); //定位信息回调函数
  ...
  // 定义全局膨胀地图
  nav_msgs::msg::OccupancyGrid globalinflatemap;
  // 定义全局esdf地图
  nav_msgs::msg::OccupancyGrid globalesdfmap;
public:
  /* data */
  // 地图分辨率
  double resolution;
...
public:
  ...
  // 返回当前里程计消息
  nav_msgs::msg::Odometry getOdom() { return odom_; }
