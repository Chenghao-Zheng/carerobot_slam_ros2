...
public:
  ...
  // 设定代价地图参数 (ROS 2 使用 rclcpp::Node::SharedPtr)
  void Set_CostMaparams(int costdownvalue_, int costupvalue_, double costdownk_, double costupk_);
