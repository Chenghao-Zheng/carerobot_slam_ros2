...
class RRTstarPlanner
{
  ...
  public:
    ...
    * @param  costmap_ros A pointer to the ROS 2 wrapper of the costmap to use for planning
    */
    ...
    // 获取系统时间最小单位是ns，在ROS 2中返回值为获取到的时间
    ...
    */
    ...
    void optimizationOrientation(std::vector<geometry_msgs::msg::PoseStamped> &plan)
    {
        ...
        {
            tf2::Quaternion q;
            q.setRPY(0, 0, atan2(plan[i+1].pose.position.y - plan[i].pose.position.y,
    ...
    void pubTreeMarker(rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr& marker_pub, visualization_msgs::msg::Marker marker, int id);
  protected:
  ...
  public:
    ...
    typedef std::shared_ptr<RRTstarPlanner> Ptr;
};
