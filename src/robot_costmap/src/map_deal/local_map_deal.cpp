...
void local_map_deal::Set_CostMaparams(int costdownvalue_, int costupvalue_, double costdownk_, double costupk_)
{
  costdownvalue = costdownvalue_;
  costupvalue = costupvalue_;
  costdownk = costdownk_;
  costupk = costupk_;
