...
private:
  ...
  double min_cost_;
  int start_id_, end_id_; // 为保证前后边界条件
...
public:
  ...
  rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr smoothPathpub;
  rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr obstaclePathpub;
